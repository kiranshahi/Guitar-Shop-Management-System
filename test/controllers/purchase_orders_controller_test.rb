...
class PurchaseOrdersControllerTest < ActionController::TestCase
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post :create, purchase_order: { delivaryDate: @purchase_order.delivaryDate, make: @purchase_order.make, price: @purchase_order.price, purchaseDate: @purchase_order.purchaseDate, quantity: @purchase_order.quantity }
    end
  ...
  test "should update purchase_order" do
    patch :update, id: @purchase_order, purchase_order: { delivaryDate: @purchase_order.delivaryDate, make: @purchase_order.make, price: @purchase_order.price, purchaseDate: @purchase_order.purchaseDate, quantity: @purchase_order.quantity }
    assert_redirected_to purchase_order_path(assigns(:purchase_order))
  end
